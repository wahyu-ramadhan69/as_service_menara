...
const RestartModal: React.FC<RestartModalProps> = ({
  ...
  const handleRestartConfirm = async () => {
    try {
      ...
      const response = await fetch(`/api/proxmox/vms/restart/${data?.vmid}`, {
        method: "PUT",
        headers: {
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 relative">
            ...
            <div className="mt-2 px-1">
              <p className="text-sm my-2">
                Restart VM {data?.vmid} tulis alasannya :
              </p>
              ...
              <div className="mb-4">
                <textarea
                  ...
                  placeholder="Tujuan restart server(opsional)"
                  required
              ...
              <div className="mt-4 flex justify-end">
                ...
                <button
                  ...
                  className="bg-sky-400 flex justify-center items-center hover:bg-sky-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                >
                  {statusPowerOff === true ? (
                    <svg
